    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attendance_sheet', models.FileField(blank=True, null=True, upload_to='test_attendance/cats/')),
                ('mark_sheet', models.FileField(blank=True, null=True, upload_to='marksheets/cats/')),
                ('pc_waiting', models.FileField(blank=True, null=True, upload_to='pc_waiting/cats/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='levels', to='useraccess.course')),
            ],
        ),
        migrations.CreateModel(
            name='StudentApp',
            fields=[
                ...
                ('total_fees', models.DecimalField(decimal_places=2, default=Decimal('0.00'), editable=False, max_digits=10)),
                ...
                ('level', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='levels', to='useraccess.level')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='unit_level', to='useraccess.level')),
            ],
        ),
        migrations.AddField(
